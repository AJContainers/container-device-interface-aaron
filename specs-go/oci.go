...
// it finds the device in the CDI spec and applies the OCI patches that
// device requires to the OCI specificiation
...
// AplyOCIEdits applies the OCI edits to the cdi spec declares globally
...
// ToOCI return the opencontainers runtime Spec Hook for this hook
...
// ToOCI return the opencontainers runtime Spec Mount for this Mount
